...
useHead({
  title: 'Contact — FitScroll',
  meta: [
    { name: 'description', content: 'Get in touch with FitScroll. Support, feedback, and press.' },
  ],
})
</script>
...
<template>
  <LegalLayout title="Contact">
    <p>
      FitScroll is built and maintained by a tiny independent team. We read every message and usually reply within
      a day or two.
    </p>
    ...
    <h2>Social</h2>
    <p>
      Follow along at <a href="https://twitter.com/fitscrollapp">@fitscrollapp</a> on X.
    </p>
  </LegalLayout>
</template>
